...
func NewKindCommand() *cobra.Command {
	var kindCmd = &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return kind.SetUp(name, kubernetesVersion, installServing, installEventing, installKindRegistry, installCamel, installKindExtraMountHostPath, installKindExtraMountContainerPath)
		},
	}
	// Set kindCmd options
